 ...
 * validation rules and the PDF renderer.
 *
...
export const ITEM_STATES = ['INCLUDED', 'NOT_APPLICABLE', 'NOT_INCLUDED']
...
export const ITEM_STATE_DESCRIPTIONS = {
...
export const TEST_RESULTS = ['PASS', 'FAIL', 'NA']
 ...
 */
export function itemLabel(section, key) {
  const definition = CHECKLIST_BY_SECTION.get(section)
  const found = definition?.items.find((i) => i.key === key)
