 ...
 *
 * Kept in one file so the rest of the app never touches the client directly and
 * the shape of a record is normalised in exactly one place.
 */
...
/** True while config.js still holds its placeholder values. */
